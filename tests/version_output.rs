...
#[test]
fn version_flag_reports_0_0_4() {
    Command::cargo_bin("codex-threads")
        .unwrap()
        .arg("--version")
        .assert()
        .success()
        .stdout(predicate::str::contains("codex-threads 0.0.4"));
}
...
fn status_reports_cli_version_in_text_and_json_without_timing() {
    ...
    let output = Command::cargo_bin("codex-threads")
        ...
        .assert()
        .success()
        .stdout(predicate::str::contains("\"cli_version\":\"0.0.4\""))
        .get_output()
        .stdout
        .clone();
    ...
    assert_eq!(json["cli_version"], "0.0.4");
